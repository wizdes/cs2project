<%@ Page Language="Nemerle" AutoEventWireup="true" CodeBehind="Default.aspx.n" Inherits="CS2.WebForms.Default" %>
    ...
    <form id="form1" defaultbutton="ButtonSearch" defaultfocus="TextBoxSearch" runat="server">
        <div>
            ...
            <asp:ObjectDataSource ID="ObjectDataSourceSearchResults" runat="server" SelectCountMethod="Count"
                EnablePaging="True" SelectMethod="Search" TypeName="CS2.WebForms.Global">
                <SelectParameters>
